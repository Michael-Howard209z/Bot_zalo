...
### Bật/Tắt Antilink
```
/antilink on    # Bật antilink
/antilink off   # Tắt antilink
```

### Quản lý Whitelist
```
/antilink add facebook.com      # Thêm domain vào whitelist
/antilink add zalo.me           # Thêm domain khác
/antilink remove facebook.com   # Xóa domain khỏi whitelist
...
1. Kiểm tra đã bật chưa: `/antilink status`
...
2. Kiểm tra link có trong whitelist không: `/antilink list`
...
- **Credits**: Adapted for zlapi - Improved
