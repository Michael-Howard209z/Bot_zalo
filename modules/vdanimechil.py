...
des = {
    ...
    'description': "𝔾𝕦̛̉𝕚 𝕧𝕚𝕕𝕖𝕠 𝕒𝕟𝕚𝕞𝕖"
}

def handle_vdanime_command(message, message_object, thread_id, thread_type, author_id, client):
    uptime_message = "Video anime của bạn đây."
    message_to_send = Message(text=uptime_message)
    
    api_url = 'https://api.ntmdz.online/images/videochill'
...
def get_mitaizl():
    return {
        'vdchill': handle_vdanime_command
    }
